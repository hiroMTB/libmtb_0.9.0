...
public:
    ...
    void makeFftData( vector<vector<float>> &fftWaves, audio::Context * ctx, fs::path src_path, int targetSampleRate=48000, float smoothingFactor=0.5, int fftSize=16, audio::dsp::WindowType windowType=audio::dsp::WindowType::BLACKMAN){
